...
def parse_args(path):
    ...
    parser.add_argument(
        '--models_dir', type=str, default='mask\pyramidbox_lite_server_mask', help='path of models.')
    parser.add_argument(
        '--video_path', type=str, default=path, help='path of video.')
    parser.add_argument(
        '--use_camera',
        type=bool,
        default=False,
...
def predict_video(args, im_shape=(1920, 1080), use_camera=False):
    ...
    writer = cv2.VideoWriter(
        os.path.join(path, name[-1] + '_result.mp4'), fourcc, fps, (width, height))
    import time
...
if __name__ == "__main__":
    path = r"C:\Users\hqk\Desktop\mask_and_face\mask\video\test_video2.mp4"
