...
def parse_args():
    ...
    parser.add_argument(
        '--models_dir', type=str, default='mask\pyramidbox_lite_mobile_mask', help='path of models.')
    parser.add_argument(
...
def predict_video(args, im_shape=(1920, 1080), use_camera=False):
    ...
    #     os.path.join(path, a + 'camera_result.mp4'), fourcc, fps, (width, height))
    import time
    ...
    # writer.release()
    # print("实时识别结束，视频文件存放于result文件夹中，视频名为{}".format(a + 'camera_result.mp4'))
